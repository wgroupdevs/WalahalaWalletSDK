...
namespace WalaSDK.Utils
{
    public static class CryptoUtils
    {
        public static string ToAddress(this UInt160 scriptHash)
        {
            ...
            var temp = data.Base58CheckEncode();
        ...
        private static ThreadLocal<WalaSDK.Cryptography.RIPEMD160> _ripemd160 = new ThreadLocal<WalaSDK.Cryptography.RIPEMD160>(() => new WalaSDK.Cryptography.RIPEMD160());
